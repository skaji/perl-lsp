...
impl<'a> Builder<'a> {
    ...
    fn expr_payload(&mut self, node: Node<'a>) -> Option<crate::model::witnesses::WitnessPayload> {
    ...
    fn record_arrow_deref(&mut self, node: Node<'a>, form: crate::model::file_analysis::DerefForm) {
    ...
    fn bag_context(&self) -> crate::model::witnesses::BagContext<'_> {
