...
fn pack_change_coordinator_defers_during_index_and_reconciles_once() {
    use crate::index::module_resolver::PackChangeCoordinator;
...
fn pack_file_changed_surface_gate_skips_consumers_on_body_edit() {
    ...
    let pack = Arc::new(crate::index::module_index::ModuleIndex::new_for_test());
    ...
    crate::index::module_resolver::pack_file_changed(None, &hub, &hdr, false);
