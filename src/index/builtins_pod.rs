...
//!
//! All actual POD walking is delegated to [`crate::build::pod`] — the
...
//!
//! Storage and lookup live in [`crate::index::module_cache`] /
//! [`crate::index::module_index`]: at startup the resolver thread writes
...
fn render_entries(pod: &str, perl_version_tag: &str) -> HashMap<String, String> {
    let mut entries = crate::build::pod::extract_perlfunc_items(pod);
