...
impl Backend {
    ...
    fn override_scope(&self) -> crate::index::resolve::OverrideScope {
...
impl Backend {
    ...
    fn record_open_doc_surface(&self, uri: &Url) -> Option<crate::index::module_index::SurfaceDirty> {
...
fn refs_to_locations(results: Vec<crate::index::resolve::RefLocation>) -> Option<Vec<Location>> {
