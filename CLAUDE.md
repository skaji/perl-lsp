...
- `model/file_analysis/` — data model; serde-derived (parts: `core_types`, `types`, `dispatch`, `ancestry`, `cross_file`, `imports`, `outline`, `lifecycle`, `surface_feed`, `queries`, `enrichment`, `class_queries`, `cursor_queries`, `invocants`, `hover`, `sym_index`, `completion`).
